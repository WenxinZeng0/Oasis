...
NODES_EN['debs_chat_2'] = {
  ...
  render: function () {
    renderChatApp({
      ...
      script: [
        { from: 'them', text: "hey you there:(? I woke up today and my brain just feels like absolute trash. Everything is gray." },
  ...
  render: function () {
    renderChatApp({
      ...
      script: [
        ...
        { from: 'them', text: "yeah, okay. go ahead I will authorize you" },
      ],
      onEnd: function () {
...
I used to think I was just clearing away the cheap, grating background noise — making people's lives a little easier. Even the "fast tempo that makes you buy things without thinking" trick — I told myself that was just how business worked.

But what am I reading now?

They're not treating anxiety. They're harvesting it. When my sister sat in front of her computer and that ad touched her, this system wasn't helping her — it was waiting for that one small crack, and then it closed around her like a trap.

All those impulses, excitements, how many of those were true?`,
...
NODES_EN['ending_b_final'] = {
  ...
  render: function () {
    renderEnding({
      label: 'ENDING B',
      title: 'The Recall',
      text: `The capsule that failed my sister was never repaired. It was recalled, replaced, but people are cancelling it, so it went  quietly forgotten.

A year later, the truth came out that shocked us heavily, the hacker exposed OASIS's manipulation for business advantage.

I feel complicated, we thought we are doing ourselves good by trying to maintain a good inner peace with that technology. But when the excitement and anxiety are controlled, we are like chess pieces that were being played. `,
...
NODES_EN['ending_collection'] = {
  ...
  render: function () {
    ...
    const allEndings = [
      ...
      { id: 'ending_b', name: 'Ending B — The Recall', hint: 'The capsule failed for good. The truth came out, a year too late.' },
    ];
