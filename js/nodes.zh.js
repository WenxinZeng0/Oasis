...
NODES_ZH['debs_chat_2'] = {
  ...
  render: function () {
    renderChatApp({
      ...
      script: [
        { from: 'them', text: "嘿你在吗:(？我的OASIS胶囊肯定出问题了" },
        { from: 'them', text: "我今天醒来感觉脑子里一团糟。" },
...
NODES_ZH['ending_a_final'] = {
  ...
  render: function () {
    renderEnding({
      ...
      title: '共鸣',
      text: `OASIS成功了。
我举报了那个黑客。我把他们想要的答案交给了OASIS。我以为自己是在保护我妹妹，
现在我坐在EchoAcoustics的新办公桌前，第三次读着这份合作公告。这个循环完成了。
在某个地方，我妹妹正贴着她的OASIS贴片，过着她的"最好的生活"。她不知道自己感受到的平静可能只是一笔交易。她不知道下次在商场里听到一首歌时，她体内的某些东西可能已经在响应了——不是对那首歌，而是对一个她本不该察觉到的信号。而我的团队，正是建造这一切的人。
我不知道自己能不能挽回这一切。我不知道是否有人能做到。`,
  ...
  render: function () {
    ...
    wrap.innerHTML = `
      ...
      <div class="doc-body">
        ...
        <p>那不是一次故障，而是一场逃亡。</p>
        <p>Pavlov对这次黑客行动给人们带来的不适感到抱歉。当胶囊突然失效时，使用者会瞬间被切断那条他们早已依赖的化学慰藉。失去了那股持续、自动输送的人造奖赏，大脑会经历一场灾难性的多巴胺崩溃，引发铺天盖地的、空洞的戒断反应。<b>即便这很艰难，切断这种依赖也是至关重要的。</b></p>
...
NODES_ZH['ending_b_final'] = {
  ...
  render: function () {
    renderEnding({
      label: 'ENDING B',
      title: '召回',
      text: `黑客攻破了那家公司，让所有胶囊都陷入了沉睡之后，整个世界渐渐远离了这种药物。我和我妹妹也一样。

Pavlov泄露的资料，彻底揭露了OASIS打着"心理健康"的名义所做的那些骇人行径。回想起当时我必须做出的那些选择，回想起自己曾多么接近落入他们的圈套……这让我感到害怕。

我们现在自由了，但我永远不会忘记这整场噩梦里最令人胆寒的真相：我们曾如此害怕自己内心那点自然的波动，以至于差一点就把自己灵魂的钥匙双手奉上。`,
